  ...
  return (
    <Dialog>
      ...
      <DialogContent className="bg-[#1a1a1a] border-white/10 text-white max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl text-[#808FA6]">Impressum</DialogTitle>
        </DialogHeader>
        
        <div className="space-y-6 text-gray-300">
          <section>
            <h3 className="text-[#A2694A] mb-2">Angaben gemäß § 5 TMG</h3>
          ...
          <section>
            <h3 className="text-[#A2694A] mb-2">Kontakt</h3>
            <p>Telefon: <a href="tel:01729037547" className="text-[#808FA6] hover:underline">01729037547</a></p>
            <p>E-Mail: <a href="mailto:kontakt@edit-immobilien.de" className="text-[#808FA6] hover:underline">kontakt@edit-immobilien.de</a></p>
          </section>

          <section>
            <h3 className="text-[#A2694A] mb-2">Aufsichtsbehörde</h3>
            ...
            <a 
              ...
              className="text-[#808FA6] hover:underline inline-flex items-center gap-1 mt-2"
            >
          ...
          <section>
            <h3 className="text-[#A2694A] mb-2">Berufsbezeichnung und berufsrechtliche Regelungen</h3>
          ...
          <section>
            <h3 className="text-[#A2694A] mb-2">EU-Streitschlichtung</h3>
            <p className="mb-2">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-[#808FA6] hover:underline inline-flex items-center gap-1"
            >
          ...
          <section>
            <h3 className="text-[#A2694A] mb-2">Verbraucherstreitbeilegung/Universalschlichtungsstelle</h3>
            <p>
