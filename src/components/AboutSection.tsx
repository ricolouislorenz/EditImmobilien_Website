...
const aboutImage = "https://placehold.co/800x600?text=About+Image";
...
export function AboutSection() {
  return (
    <section id="uber-uns" className="py-16 bg-[#121212]">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <div className="bg-[#0a0a0a] p-6 rounded-xl border-2 border-white/10 hover:border-[#808FA6] transition-all duration-300 hover:shadow-2xl hover:shadow-[#808FA6]/20">
              <h3 className="text-[#808FA6] mb-3">Wer wir sind</h3>
            ...
            <div className="bg-[#0a0a0a] p-6 rounded-xl border-2 border-white/10 hover:border-[#808FA6] transition-all duration-300 hover:shadow-2xl hover:shadow-[#808FA6]/20">
              <h3 className="text-[#808FA6] mb-3">Unsere Expertise</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
          ...
          <div className="flex justify-center mb-10">
            <div className="relative group max-w-lg">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#808FA6] to-[#A2694A] rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-300"></div>
              <div className="relative">
                <img 
                  src={aboutImage} 
                  alt="Edit Immobilien Team" 
                  className="w-full rounded-xl border-2 border-[#808FA6]/30 shadow-2xl"
                />
          ...
          <div className="border-t border-white/10 pt-8">
            <h3 className="text-center text-[#808FA6] mb-6">Unsere Werte</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <div key={index} className="bg-[#121212] p-6 rounded-xl border-2 border-white/10 hover:border-[#808FA6] transition-all duration-300 hover:shadow-2xl hover:shadow-[#808FA6]/20">
                  <div className="flex justify-center mb-4">
                    <div className="w-12 h-12 bg-[#808FA6]/10 rounded-full flex items-center justify-center border-2 border-[#808FA6]/20">
                      <feature.icon className="w-6 h-6 text-[#A2694A]" />
                    </div>
                  </div>
                  <h4 className="mb-3 text-center text-[#808FA6]">{feature.title}</h4>
